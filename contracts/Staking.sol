...
contract Staking is Ownable {
    ...
    uint256 public withdrawPeriod = 1 hours;
    ...
    function deposite(uint256 _amount) public {
        ...
        request.timeNextClaim = block.timestamp + 1 hours;
                        ...
                        if (requests[i].lender == msg.sender) {
                            ...
                            if (
                                ...
                                stakingDuration = (block.timestamp -
                                    requests[i].timeLastClaim).div(60).div(60);
                            } else {
            ...
            if (!req.retrieved) {
                if (req.lendId >= 0) {
                    if (req.lender == msg.sender) {
                        ...
                        req.timeNextClaim = block.timestamp + 1 hours;
